...
speed_km_h = 0  # Add this line to define the global speed variable

def colorWipe(strip, color, wait_ms=100, acceleration=1.03, max_speed_km_h=10):
    ...
    # Initialize the speed and acceleration
    ...
    while True:
        for i in range(strip.numPixels() - 2):
            ...
            # Calculate the delay time based on the current speed
